...
class FeedController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $feeds = Feed::with('likes')
                     ...
                     ->select('id','user_id','postType','content','created_at','feed_id','feedPostType','youtube')
                     ->where('id',$id)
                     ->first();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->only(['content','postType','feedType','youtube']);
                ...
                if ($request->hasFile('filename')){
                    ...
                    if (is_array($picture)) {
                        ...
                        foreach ($picture as $p) {
                            $pictures[] = $p;
                            $upload = Cloudder::upload($p, null,array("public_id" => "feed/".uniqid(), "width"=>600, "height"=>600, "sign_url" => true, "fetch_format"=>"auto","quality"=>"auto",  "flags"=>array("progressive", "progressive:semi", "progressive:steep")));
